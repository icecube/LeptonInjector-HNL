...
I3TableRowDescriptionPtr EventPropertiesConverter::CreateDescription(const BasicEventProperties& p){
	...
	desc->AddField<double>("mHNL", "GeV", "HNL mass");
	desc->AddField<double>("distance", "m", "HNL decay length");
	desc->AddField<double>("distanceMin", "m", "HNL min decay length");
	desc->AddField<double>("distanceMax", "m", "HNL max decay length");
	desc->AddField<double>("lifetime", "ns", "HNL proper lifetime");
	desc->AddField<double>("decay_channel", "unitless", "HNL decay channel");
	desc->AddField<double>("outgoingNeutrinoEnergy", "GeV", "Energy of outgoing Neutrino (in 2-body decay)");
	desc->AddField<bool>("physical", "unitless", "Whether this was a physical event (kinematics)");
