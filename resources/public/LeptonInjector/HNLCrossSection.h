 ...
 *
 */
#ifndef HNLCROSSSECTION_H
#define HNLCROSSSECTION_H
...
class HNLCrossSection
{
    public:
        ...
        HNLCrossSection(const HNLCrossSection&)=default;
        HNLCrossSection(HNLCrossSection&&)=default;

        ~HNLCrossSection()=default;

        HNLCrossSection& operator=(const HNLCrossSection&)=default;
        HNLCrossSection& operator=(HNLCrossSection&&)=default;
        ...
        finalStateRecord sampleFinalState_DIS(double HNL_mass, double energy,
                                        I3Particle::ParticleType scatteredType,
                                        boost::shared_ptr<I3RandomService> random) const;

        
        // the GR sampler just returns X=1
        finalStateRecord sampleFinalState_GR(double HNL_mass, double energy,
                                        I3Particle::ParticleType scatteredType,
                                        boost::shared_ptr<I3RandomService> random) const;
